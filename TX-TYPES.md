...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `0x00` LegacyTx / LegacyTx (12-field celo variant) / TxTypeLegacyTransaction / legacy | = |  |  |  |  | ⚠️ | = |  |  |  |  |  |  |  | ⚠️ |  |  | = |  |
| `0x01` AccessListTx / EIP-2930 access list | = |  |  |  |  |  | = |  |  |  |  |  |  |  |  |  |  | = |  |
| `0x02` DynamicFeeTx / EIP-1559 dynamic fee | = |  |  |  |  |  | = |  |  |  |  |  |  |  |  |  |  | = |  |
| `0x03` BlobTx / EIP-4844 blob | = |  |  | ➖ |  |  | ⊘ | ➖ |  |  |  |  |  |  |  |  | ➖ | unrecorded | ➖ |
| `0x04` SetCodeTx / EIP-7702 set code | = |  |  | ➖ | ➖ |  | = |  |  |  |  |  |  | ➖ |  |  |  | unrecorded | ➖ |
